              ...
              $time = (strlen($exdate[1]<=4))? $exdate[0]." &nbsp;&nbsp;".$exdate[1] : $item->created_at->format('d M Y, G:i');
                  ...
                  {{ $time }}
                    ...
                    <td>
                     ...
                     <td>
                       @can('discussion-edit')
                        <a href=" {{ url("/dash-discussion/$item->id/dash_edit") }}"> <i class="fa fa-pencil"></i> Edit Record</a>
                        @endcan
                      </td>         
                    ...
                    <td>
                      ...
                      "> <i class="fa fa-trash-o"></i> Delete Record</a>
                       <form id="delete-form" method="post"  action="{{ route('dash-discussion-delete',[$item->id]) }}">
