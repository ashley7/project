...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="demo-form2" method="POST" action="{{ route('users.store') }}" autocomplete="off" data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="othername" name="othername" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <p>
                                Male:
                                <input type="radio" class="flat" name="gender" id="Male" value="Male" required /> Female:
                                <input type="radio" class="flat" name="gender" id="Female" value="Female" />
                            </p>
                        </div>
                    </div>
